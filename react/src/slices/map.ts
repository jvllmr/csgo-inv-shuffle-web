...
OpenRequest.onsuccess = () => {db = OpenRequest.result; document.dispatchEvent(mapDBReadyEvent)}
...
export const selectMapDBReady = (state: RootState): boolean => state.map.DBready;
